/*******************************************************************************
 * ParticleModuleEventReceiverSpawn generated by Eliot.UELib using UE Explorer.exe.
...
var(Rotation) bool bInheritRotation;
var(Velocity) RawDistributionVector InheritVelocityScale;

defaultproperties
{
    SpawnCount=/*ERROR: System.ArgumentException: Requested value '*' was not found.
   ...
   at UELib.Core.UDefaultProperty.TryDeserializeDefaultPropertyValue(PropertyType type, DeserializeFlags& deserializeFlags)*/
    InheritVelocityScale=/*ERROR: System.ArgumentOutOfRangeException: Index was out of range. Must be non-negative and less than the size of the collection.
